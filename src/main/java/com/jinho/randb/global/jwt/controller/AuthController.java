...
import com.jinho.randb.global.jwt.service.JwtAuthService;
...
public class AuthController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200",description = "OK",
                    content = @Content(schema = @Schema(implementation = ControllerApiResponse.class),
                            examples = @ExampleObject(value = "{\"success\":true,\"message\" :\"조회 성공\", \"data\": {\"id\":\"account_id\",\"loginId\":\"로그인 아이디\",\"userName\":\"닉네임\",\"loginType\":\"normal\"}}"))),
            @ApiResponse(responseCode = "401" ,description = "Unauthorized",
                    content = @Content(schema = @Schema(implementation = ErrorResponse.class),
    ...
    public ResponseEntity<?> getUserInfo(HttpServletRequest request){
        try{
            ...
            AccountInfoResponse info = jwtAuthService.accessTokenMemberInfo(token);
